...
<a href="https://www.youtube.com/watch?v=4vIkaZ1qb74">$\textcolor{brown}{\textsf{YouTube Video by Blaine Robertson}}$</a>
```diff
- text in red
+ text in green
! text in orange
...
$${\color{lightgreen}Light \space Green \color{lightblue}Light \space Blue}$$  $${\color{lightblue}Light \space Blue}$$
Basic
Code	Appearing
